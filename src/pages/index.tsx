        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12">
            <div className="text-center">
              ...
              <h3 className="mt-4 sm:mt-6 text-lg sm:text-xl font-bold text-gray-900">Configuration rapide</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="mt-4 sm:mt-6 text-lg sm:text-xl font-bold text-gray-900">Service clientèle 7/7</h3>
              <p className="mt-2 sm:mt-3 text-sm sm:text-base text-gray-500 px-2">
            ...
            <div className="text-center">
              ...
              <h3 className="mt-4 sm:mt-6 text-lg sm:text-xl font-bold text-gray-900">Pour tous les budgets</h3>
              <p className="mt-2 sm:mt-3 text-sm sm:text-base text-gray-500 px-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12">
            <div className="relative">
              <div className="flex justify-center">
                <div className="h-12 w-12 sm:h-16 sm:w-16 rounded-full bg-gradient-to-br from-purple-600 to-orange-500 text-white flex items-center justify-center text-lg sm:text-2xl font-bold">1</div>
              </div>
              <h3 className="mt-4 sm:mt-6 text-lg sm:text-xl font-bold text-gray-900 text-center">Choisissez votre forfait</h3>
            ...
            <div className="relative">
              <div className="flex justify-center">
                <div className="h-12 w-12 sm:h-16 sm:w-16 rounded-full bg-gradient-to-br from-purple-600 to-orange-500 text-white flex items-center justify-center text-lg sm:text-2xl font-bold">2</div>
              </div>
              <h3 className="mt-4 sm:mt-6 text-lg sm:text-xl font-bold text-gray-900 text-center">Recevez votre eSIM</h3>
              <p className="mt-2 sm:mt-3 text-sm sm:text-base text-gray-500 text-center px-2">
            ...
            <div>
              <div className="flex justify-center">
                <div className="h-12 w-12 sm:h-16 sm:w-16 rounded-full bg-gradient-to-br from-purple-600 to-orange-500 text-white flex items-center justify-center text-lg sm:text-2xl font-bold">3</div>
              </div>
              <h3 className="mt-4 sm:mt-6 text-lg sm:text-xl font-bold text-gray-900 text-center">Connectez-vous</h3>
              <p className="mt-2 sm:mt-3 text-sm sm:text-base text-gray-500 text-center px-2">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="space-y-4 sm:space-y-6">
              {[
                ...
                <div key={index} className="bg-white rounded-xl shadow-sm p-4 sm:p-6 hover:shadow-md transition-shadow duration-200 border border-purple-100">
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900">{faq.question}</h3>
                  <p className="mt-2 text-sm sm:text-base text-gray-500">{faq.answer}</p>
                </div>
              ))}
            </div>
