...
export default function Compatibilite() {
  return (
    <div className="max-w-2xl mx-auto py-16 px-4 text-center">
      ...
      <div className="mt-8">
        <a href="https://www.gsma.com/esim/devices/" target="_blank" rel="noopener noreferrer" className="inline-block bg-purple-600 text-white px-6 py-3 rounded-full font-semibold hover:bg-purple-700 transition mb-4">Voir la liste officielle GSMA</a>
      </div>
    </div>
  )
} 